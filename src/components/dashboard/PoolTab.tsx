  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">Real-time data from the WhisperWaffle liquidity pool (wALEO ↔ wUSDC)</p>
      </div>
        ...
        {poolData && (
          <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
            <div className="text-sm text-green-800">
              ...
              <div>Last updated: {poolData.lastUpdated ? new Date(poolData.lastUpdated).toLocaleTimeString() : 'Unknown'}</div>
            </div>
          </div>
        )}
      </div>

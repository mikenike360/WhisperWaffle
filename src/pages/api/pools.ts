...
const candidateUrls = (programId: string, mapping: string, key?: string) => {
  ...
  console.log(`[candidateUrls] CURRENT_NETWORK: ${CURRENT_NETWORK} (${typeof CURRENT_NETWORK}), networkStr: ${networkStr}, isMainnet: ${isMainnet}, networkSuffix: ${networkSuffix}`);
